function  init_paginator_contentdrupalnotes(a, b, c, d) {

    a = a, cdnitemsPorPagina = b, cdnnumerosPorPagina = 8,  d = id_category
}
...
function cargaPaginacontentdrupalnotes(a) {
  ...
  $(".fcontentdrupalnotes").animate({left: '0px'});
    ...
    cdnpagina = a,
        cdndesde = cdnpagina * cdnitemsPorPagina, get_datacdn(),

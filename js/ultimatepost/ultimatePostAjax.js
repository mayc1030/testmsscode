...
function getDataCallbackultimateposts(domainurl,categoria){
        ...
        $.each(objc, function(key,value){
                ...
                $('<li><img src="img/myproyect2.jpg" alt="Navigation avatar" data-target="#carousel-proyects" data-slide-to="'+ key+1 +'" class="img-fluid img-circle"></li>').appendTo($("#carousel-proyects .carousel-indicators"));

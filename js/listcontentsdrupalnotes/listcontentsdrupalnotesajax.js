        ...
        $.each(objc, function(key,value){
            if(key == "lista"){
                $.each(value, function(i,val){
                    ...
                    $(".img-listdrupalnotes").append("<div class='info-img'><a  href='drupalnotes?id="+val.nid+"'><img src='backend/"+val.ruta+"' height='30' width='30' alt='Avatar' class='img-circle'></a></div>").fadeIn();
